  ...
  return (
    <div className="">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://i.pinimg.com/736x/6f/d6/a2/6fd6a26fb0796232641ffdb2064c72a6.jpg')",
        }}
      >
        <div className="absolute inset-0 "></div>
        <motion.h1
          className="text-5xl sm:text-6xl font-bold text-black z-10 text-center pt-32"
      ...
      <section className="py-16  text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.p
            className="text-lg text-white-800 leading-relaxed text-center"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 1 }}
          >
            Soravuan University is a premier institution in Jharkhand, recognized
